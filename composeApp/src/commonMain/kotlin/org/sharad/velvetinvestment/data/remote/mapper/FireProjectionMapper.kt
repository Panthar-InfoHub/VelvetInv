...
import org.sharad.velvetinvestment.data.remote.model.firereport.Data
...
import org.sharad.velvetinvestment.domain.models.fire.FireScenarioDomain
...
private fun Data.toScenarioDomain(): FireScenarioDomain {
    ...
    return FireScenarioDomain(
        startYear = projection.firstOrNull()?.year ?: 0,
        endYear = projection.lastOrNull()?.year ?: 0,
